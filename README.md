making an edit from the github web interface
...
strike you as either similar to or different from Python.
  - semicolons required at the end of the line
  - logical operators are different
  - blocks are defined by braces instead of indentation
  - elif is else if
  - for loop is funny now
